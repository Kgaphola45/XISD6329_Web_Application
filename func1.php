...
if(isset($_POST['docsub1'])){
	...
	$query="select * from caregiver where username='$dname' and password='$dpass';";
...
function display_docs()
{
	...
	{
		$name=$row['name'];
		# echo'<option value="" disabled selected>Select Caregiver</option>';
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="patientdetails.php" role="tab" aria-controls="home">Elders List</a>
      ...
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Caregivers Section</a>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="appointment.php">
                <div class="row">
                  ...
                  <div class="col-md-4"><label>Caregiver:</label></div>
                  <div class="col-md-8">
